...
class UpdateHousingDataRequest extends FormRequest
{
    /**
    ...
    {
        $housingDataId = $this->route('housing_data')?->id;

        return [
            'nik' => 'required|string|size:16|unique:housing_data,nik,' . $housingDataId,
